        ...
        <table class="formTable">
            <tr>
                ...
                <td>
                    ...
                    <input id="name" name="name" type="text" value="${permission.name }" class="easyui-validatebox"
            ...
            <tr>
                <td>权限编码：</td>
                <td>
                    <input id="permCode" name="permCode" type="text" class="easyui-validatebox"
                           data-options="width: 180" value="${permission.permCode }"/>
                </td>
            </tr>
            <tr>
                <td>访问路径：</td>
                <td><input id="url" name="url" type="text" value="${permission.url }" class="easyui-validatebox"
                           data-options="width: 180" class="easyui-validatebox"/></td>
            </tr>
            <tr>
                <td>上级菜单：</td>
